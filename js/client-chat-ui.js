    ...
    var prepareEvent = function(event) {
        switch(event.event) {
            ...
            case 'chat_session_timeout_warning':
                ...
                event.msg = event.msg ? escapeHtml(event.msg) : 'We have not heard from you for some time. Please respond within the next few minutes to prevent your chat session from ending.';
                event.originalMsg = event.msg;
                break;
