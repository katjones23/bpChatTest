...
<script type="text/javascript" src="emoji/js/config.js"></script>
<script type="text/javascript" src="emoji/js/util.js"></script>
<script type="text/javascript" src="emoji/js/jquery.emojiarea.js"></script>
<script type="text/javascript" src="emoji/js/emoji-picker.js"></script>
    ...
    var forms = {
        ...
        find_agent_form: {
            ...
            onShow: function() {
                ...
                window.setTimeout(function() {autosize($('#input-field,.emoji-wysiwyg-editor'));}, 400);
            },
            onHide: function() {
                window.chatSession.sessionStatus = undefined;
                $('#chat-body').hide();
...
//            $('#error').css('display', 'block');
    ...
    $(document).ready(function() {
        ...
        cp.parameters.phone_number     = cp.phone_number;
        ...
        cp.parameters.user_platform = {};
        cp.parameters.user_platform.browser = platform.name + " " + platform.version;
        cp.parameters.user_platform.os = platform.os.toString();
        cp.parameters.user_platform.description = platform.description;        
        ...
        $('body').on('keyup', '.emoji-wysiwyg-editor', function () {
            $('#input-field').val($('.emoji-wysiwyg-editor').text());
            var h=$('.emoji-wysiwyg-editor').height()+12
            if($('.emoji-wysiwyg-editor').prop("scrollHeight")==h){
                $('.emoji-wysiwyg-editor').height(17);
            }
            $('.emoji-wysiwyg-editor').height($('.emoji-wysiwyg-editor').prop("scrollHeight")-14);
            var bottom = $('.emoji-wysiwyg-editor').height() + 25;
...
<div id="servicepatternsite-iframe-chat">
    <div id="header-avatar" class="header light">
        <div id="header-avatar-container">
            <div class="has-avatar">
                ...
                <div class="info">
                    <div id="agent-name" class="agent-name">New Chat</div>
        ...
        <div id="offline-form-inner" >
            ...
            <div id="questionForm">
                ...
                <div class="field-wrapper">
                    <input id="first_name" type="text" class="input-field" name="first_name" placeholder="First name*" required>
                    <div id="error-first_name" class="error-balloon">Please, enter first name</div>
                </div>

                <div class="field-wrapper">
                    <input id="last_name" type="text" class="input-field" name="last_name" placeholder="Last name*" required>
                    <div id="error-last_name" class="error-balloon">Please, enter last name</div>
                </div>

                <div class="field-wrapper">
                    <input id="account_number" type="text" class="input-field" placeholder="Account id">
                </div>

                <div class="field-wrapper">
                    <input id="email" type="text" class="input-field" placeholder="Your email*" required>
                    <div id="error-email" class="error-balloon">Please, enter valid email</div>
                </div>

                <div class="field-wrapper message">
                    <textarea id="question" class="input-field" placeholder="Your message*" required></textarea>
                    <div id="error-question" class="error-balloon multiline">Please, enter message</div>
                </div>
            ...
            <div id="callbackForm">
                <div>
                    <div class="field-wrapper">
                        <input id="cb-FIRST_NAME" type="text" class="input-field" placeholder="Your first name*" required>
                        <div id="error-cb-FIRST_NAME" class="error-balloon">Please, enter first name</div>
                    </div>

                    <div class="field-wrapper">
                        <input id="cb-LAST_NAME" type="text" class="input-field" placeholder="Your last name*" required>
                        <div id="error-cb-LAST_NAME" class="error-balloon">Please, enter last name</div>
                    </div>

                    <div class="field-wrapper">
                        <input id="cb-PHONE" type="text" class="input-field" placeholder="Your phone number*" required>
                        <div id="error-cb-PHONE" class="error-balloon">Please, enter phone number</div>
                    </div>

                    <div class="field-wrapper">
                        <input id="cb-EMAIL" type="email" class="input-field" placeholder="Your email" >
                    </div>

                    <div class="field-wrapper">
                        <input id="cb-ACCOUNT" type="text" class="input-field" placeholder="Your account">
                    </div>

                    <div class="field-wrapper">
                        <input id="cb-COMPANY" type="text" class="input-field" placeholder="Your company">
                    </div>

                    <div class="field-wrapper message">
                        <textarea id="cb-TEXT" style="height: 65px;" class="input-field" placeholder="Your message"></textarea>
                    </div>

                    <div class="buttons">
                        <div class="left-button">
                            <a id="cb-cancel" class="servicepatternBtn cancel" href="#">Cancel</a>
                        </div>
                        <div>
                            <input id="cb-submit" type="button" value="Call me when ready" class="servicepatternBtn accept">
                        </div>
                    </div>
            ...
            <div id="unavailableForm">
                <div id="offline-form-fields">
                    ...
                    <div class="field-wrapper">
                        ...
                        <div id="error-unemail" class="error-balloon">Please, enter valid email</div>
                    </div>
            ...
            <div id="surveyForm">
                ...
                <div class="description small">How likely are you to recommend our products and services in the future?</div>
                <p>
                    <div class="thumbUp"></div>
                    <div class="thumbDown"></div>
    ...
    <div id="chat-body" style="display: none;">
        ...
        <div id="notification-prompt" style="display: none;" class="promptMessage">When prompted, please allow notifications from this window so you can see responses when this window is hidden.</div>
        ...
        <div id="input-div" class="">
            <div class="input-div-table">
                ...
                <div class="td-textarea">
                    <textarea id="input-field" data-emojiable="true" rows="1" name="input-field" maxlength="1000" placeholder="Type here and hit <Enter>" autocomplete="off" style="resize: none;"></textarea>
                </div>
                <div class="td-button">
